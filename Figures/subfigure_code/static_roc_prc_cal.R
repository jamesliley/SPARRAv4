...
sc=1
ggsave("Figures/pdfs/Unsorted/static_score_roc.pdf",rx,
...
ggsave("Figures/pdfs/Unsorted/static_score_prc.pdf",px,
       width = sc*7.5, height = sc*7.25, units = "cm",
       device = cairo_pdf)
...
ggsave("Figures/pdfs/Unsorted/static_score_cal.pdf",cx,
       width = sc*7.5, height = sc*7.25, units = "cm",
       device = cairo_pdf)