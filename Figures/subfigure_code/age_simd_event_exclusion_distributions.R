...
ggsave("Figures/pdfs/Unsorted/age_simd_density.pdf",
...
pdf("Figures/pdfs/Unsorted/exclusions_venn.pdf",width=4,height=4)
grid.newpage()
...
ggsave("Figures/pdfs/Unsorted/age_simd_distributions.pdf",
...
# General plot
pdf("Figures/pdfs/Unsorted/event_type.pdf",width=5,height=5)
