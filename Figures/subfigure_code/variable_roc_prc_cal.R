...
ggsave("Figures/pdfs/Unsorted/variable_score_roc.pdf",
...
# Save the plot to a file
ggsave("Figures/pdfs/Unsorted/variable_score_prc.pdf",
       width = 7.5, height = 7.25, units = "cm",
       device = cairo_pdf)
...
# Save the plot to a file
ggsave("Figures/pdfs/Unsorted/variable_score_cal.pdf",
       width = 7.5, height = 7.25, units = "cm",
       device = cairo_pdf)
